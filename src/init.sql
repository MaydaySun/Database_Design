...
values (4, '普通员工');
-- 向staff_to_role插入信息
insert into staff_to_role
values ('00000000000', 1);
insert into staff_to_role
values ('00000000001', 2);
insert into staff_to_role
values ('00000000002', 3);
insert into staff_to_role
values ('00000000003', 4);
...
-- 向teacher_to_course插入信息
insert into teacher_to_course(course_id, teacher_id)
values (1, '00000000002');
insert into teacher_to_course(course_id, teacher_id)
values (2, '00000000002');
insert into teacher_to_course(course_id, teacher_id)
values (3, '00000000002');

-- 向course_to_section插入信息
insert into course_to_section
values (1, 1, 1);
insert into course_to_section
values (2, 2, 1);
insert into course_to_section
...
-- 向staff_to_course插入信息
insert into staff_to_course
values ('00000000003', 3, null, null, 0, 0);
insert into staff_to_course
values ('00000000004', 1, null, null, 0, 0);
insert into staff_to_course
values ('00000000003', 1, null, null, 0, 0);
